...
struct ReportsView: View {
    ...
    var body: some View {
        NavigationView {
            ZStack {
                if viewModel.reportItems.isEmpty {
                    ...
                    List {
                        ...
                        SwiftUI.Section(header: Text("Report Type")) {
                        ...
                        SwiftUI.Section(header: Text("Date Range")) {
                        ...
                        // Report Preview
                        SwiftUI.Section(header: Text("Preview")) {
            ...
            .onAppear {
                viewModel.updateReport(type: selectedReportType, dateRange: selectedDateRange)
            }
...
struct ExportOptionsSheet: View {
    ...
    var body: some View {
        NavigationView {
            List {
                SwiftUI.Section(header: Text("Export Format")) {
                ...
                SwiftUI.Section(header: Text("Report Details")) {
                    HStack {
                        Text("Type")
                        Spacer()

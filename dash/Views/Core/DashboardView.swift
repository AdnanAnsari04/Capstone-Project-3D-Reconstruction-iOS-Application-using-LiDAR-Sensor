...
struct DashboardView: View {
    ...
    enum Feature: String, CaseIterable, Identifiable {
        ...
        case threeDReconstruction = "3D Reconstruction"
        ...
        var icon: String {
            ...
            case .threeDReconstruction: return "cube.transparent"
        ...
        var description: String {
            ...
            case .threeDReconstruction: return "Create 3D models from real objects"
    ...
    private var availableFeatures: [Feature] {
        ...
        switch userRole {
        case .admin:
            return [.userManagement, .debugUser, .about, .threeDReconstruction]
